...
The result we get here is pretty colose the the theorethical values from proble 5.6. 

# problem 5.13

The two importance function I am choosing are $\phi_1(x) = \frac{1}{x^{1.5}}$ and $\phi_2(x) = 0.3e^{-0.3x+0.3}$ 

The first one is a Pareto distribution with scale 1 and shape 0.5.  

The second one is a shifted exponeitnal distribuiton with shift 1 and rate 10/3.
